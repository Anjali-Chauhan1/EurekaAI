...
export default function ExportButtons({ data, topic, geminiPoints, webResults }) {
  const handleExportPDF = async () => {
    try {
      ...
      // Main title without emoji (jsPDF doesn't handle emojis well)
      pdf.setFontSize(24);
      ...
      pdf.text(`Generated on: ${currentDate} | Powered by NovaSearch`, margin, yPosition);
      yPosition += 15;
      ...
      if (webResults && webResults.length > 0) {
        ...
        webResults.forEach((result, index) => {
          ...
          pdf.setFont(undefined, 'normal');
          pdf.setTextColor(30, 30, 30);
          const cleanTitle = result.title.replace(/[^\x00-\x7F]/g, '').trim();
          const titleText = pdf.splitTextToSize(cleanTitle, pageWidth - 2 * margin - 20);
      ...
      pdf.setFontSize(8);
      pdf.setTextColor(100, 100, 100);
      pdf.text('Generated by NovaSearch - Your AI Research Assistant', margin, footerY);
  ...
  const handleExportMD = () => {
    try {
      ...
      markdownContent += `📅 **Generated on:** ${currentDate} | ⚡ **Powered by:** NovaSearch\n\n`;
      markdownContent += `---\n\n`;
      ...
      markdownContent += `*Generated by NovaSearch - Your AI Research Assistant* 🚀\n`;
